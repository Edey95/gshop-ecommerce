<template>
  <nav class="navbar navbar-expand-lg navbar-light bg-white w-100 navigation" id="navbar">
    <div class="container">
      <RouterLink class="navbar-brand font-weight-bold" to="/">G-Shop</RouterLink>
      ...
      <ul class="top-menu list-inline mb-0 d-none d-lg-block" id="top-menu">
        ...
        <!-- Account -->
        <li class="nav-item dropdown dropdown-slide list-inline-item">
          <a href="#" class="nav-link dropdown-toggle" id="navbarDropdown5" role="button" data-delay="350"
            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="tf-ion-ios-person mr-3"></i></a>
